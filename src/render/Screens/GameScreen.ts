...
export class GameScreen extends DynamicGameBasedScreen {
    ...
    updatePoints() {
        ...
        this.last_points_span.innerText = formatPoints(
            this.game.lastPontuation,
        );
    }
    ...
    updateDimensions() {
        ...
        this.gameCanvas.height =
            game.height * game.squareWidth + game.height - 1;

        this.nextCanvas.width =
            game.squareWidth * game.nextCanvasSize.width +
            game.nextCanvasSize.width -
            1;
        this.nextCanvas.height =
            game.squareWidth * game.nextCanvasSize.height +
            game.nextCanvasSize.height -
            1;
    }
